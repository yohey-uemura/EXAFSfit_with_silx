...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.cB_WindowType.setItemText(0, _translate("Form", "hanning"))
        self.cB_WindowType.setItemText(1, _translate("Form", "kaiser"))
